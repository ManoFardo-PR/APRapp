...
export const appRouter = router({
  ...
  aprs: router({
    ...
    // Enhance description with AI (called before creating APR)
    enhanceDescription: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        // Import AI module
        const { enhanceDescriptionWithAI } = await import("./aprAI");

        // Enhance description with AI
        const enhancedDescription = await enhanceDescriptionWithAI(
